...
test('publishing forwards randomization and shared reads preserve it', async () => {
  ...
  await publish({ data: { problemSets: [{ id: 's', title: 'Test' }], questions: [{ setId: 's', choices: ['a','b','c','d'], answerIndex: 0, distractors: ['e','f'], shuffleChoices: false }] }, setId: 's', visibility: 'public', authorName: 'Test' });
