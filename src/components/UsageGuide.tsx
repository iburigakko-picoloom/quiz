...
const steps: Step[] = [
  ...
  { page: 'create', target: '[data-guide="create-explanation"]', title: 'ためた疑問を、詳しい解説に', body: 'ここで問題セットを選びます。まだ回答されていないメモの依頼文をまとめてコピーできます。すでに解説がある問題への追加メモも対象です。' },
  { page: 'create', example: 'overview', title: '一覧から、未解説の疑問をまとめて依頼', body: '問題セットの「詳細解説一覧」でも、上のボタンからコピーできます。対象は保存済みで、まだ回答されていないメモです。追加メモも含みます。コピーした端末で回答を取り込んでください。' },
