...
【通常解説】
重要語・判断を分ける条件を1問あたり1〜3箇所だけ**太字**で囲んでください（例：**否定語**に注意）。通常解説では青い太字で表示されます。文全体は強調せず、HTMLや色指定タグは使わないでください。
...
【通常解説】
重要語・判断を分ける条件を1問あたり1〜3箇所だけ**太字**で囲んでください（例：**否定語**に注意）。通常解説では青い太字で表示されます。文全体は強調せず、HTMLや色指定タグは使わないでください。原文の問題文・選択肢には強調を追加しないでください。
