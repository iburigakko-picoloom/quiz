...
{"setTitle":"問題集名","source":"資料名","questions":[{"id":"q001","category":"主題","question":"問題文","choices":["正解","誤答1","誤答2","誤答3"],"answerIndex":0,"explanation":"**重要な条件**が判断の決め手です。実際の出力では正解の根拠と誤答との差を具体的に説明します。","reference":"資料名 p.3"}]}
